...
class TestProductModel(unittest.TestCase):
    ...
    def test_update_a_product(self):
        ...
        product.description = "An Updated description"
        product.update()

        self.assertEqual(product.id, original_id)
        self.assertEqual(product.description, "An Updated description")

        prods = Product.all()
        self.assertEqual(prods[0].id, original_id)
        self.assertEqual(prods[0].description, "An Updated description")
